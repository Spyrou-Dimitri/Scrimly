...
new #[Layout('layouts::team')] class extends Component
{
    ...
    public function addSubtask(): void
    {
        if (empty($this->newSubTask) || mb_strlen($this->newSubTask) < 3) {
            session()->flash('errorNewSubtask', __('pages/tasks/edit.error_too_short_subtask'));
    ...
    public function addLink(): void
    {
        ...
        if ($url === '') {
            session()->flash('errorNewLink', __('pages/tasks/edit.error_empty_link'));
    ...
    {
        return $this->view()->title(__('pages/tasks/edit.title'));
    }
};
...
<div>
    <section class="flex flex-col gap-8" aria-labelledby="tasks-edit-heading">
        <h2 id="tasks-edit-heading" class="text-2xl font-bold">
